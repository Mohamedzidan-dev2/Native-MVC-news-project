...
<style>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <div class="col-lg-12">
                <a href="<?=DOMAIN_NAME;?>admin/addUser" class="btn btn-primary">  <span style="color: black;"><i class="fa fa-user-plus" aria-hidden="true"></i></span> <span style="color:white ;">Add USERS </span></a>
                <br>
                <br>
               <table class="table table-hover table-bordered table-striped">
                ...
                <?php  $id=1;  foreach($data as $d){      ?>    
                    <tr>
                        <td><?=  $id++;?></td>
                        <td width='50%';> <?=  $d['name'];?></td>
                       
                        <td><?=  $d['email'];?></td>
                        <td><?php  $g = $d['gender'];
                            if($g =="1"){echo"male";}else{echo"female";}
                        ?>
                        </td> 
                        <td>
...
if ($userlogin['priv_number'] >= 100 && $userlogin['priv_number'] < 200) {
    ...
    ?>                      
                            ...
                            <a class="btn btn-primary" href="<?=DOMAIN_NAME;?>admin/EditUser/<?= $d['id'];?>"><span style="color:black ;"><i class="fa fa-pencil" aria-hidden="true"></i></span> Edit</a>
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-body">
                                    Are You Sure To Delete this User : <span style="color: red;"><?= $d['name'];?></span>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                    <a href="<?= DOMAIN_NAME;?>admin/DeleteUser/<?= $d['id']; ?>" class="btn btn-primary">Save changes</a>
                                </div>
                                </div>
                            </div>
                            </div>
