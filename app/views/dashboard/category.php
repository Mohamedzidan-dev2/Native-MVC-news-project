...
<style>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <div class="col-lg-12">
                <a href="<?=DOMAIN_NAME;?>admin/addCategory" class="btn btn-primary">  <span style="color: black;"><i class="fa fa-pencil-square-o fa-lg" aria-hidden="true"></i></span> <span style="color:white ;">Add Category </span></a>
                <br>
                <br>
...
if ($userlogin['priv_number'] >= 100 && $userlogin['priv_number'] < 200) {
    ...
    ?>  
                            ...
                            <a class="btn btn-primary" href="<?=DOMAIN_NAME;?>admin/editCategory/<?= $d['id'];?>"><span style="color:black ;"><i class="fa fa-pencil" aria-hidden="true"></i></span> Edit</a>
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-body">
                                    Are You Sure To Delete this Category : <span style="color: red;"><?= $d['name'];?></span>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                    <a href="<?= DOMAIN_NAME;?>admin/deleteCategory/<?= $d['id']; ?>" class="btn btn-primary">Save changes</a>
                                </div>
                                </div>
                            </div>
                            </div>
