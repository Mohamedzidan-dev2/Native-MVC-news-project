<footer class="footer">
    ...
    <!-- Core JavaScript
    ================================================== -->
    <script src="<?= DOMAIN_NAME;?>front/js/jquery.min.js"></script>
    <script src="<?= DOMAIN_NAME;?>front/js/tether.min.js"></script>
    <script src="<?= DOMAIN_NAME;?>front/js/bootstrap.min.js"></script>
    <script src="<?= DOMAIN_NAME;?>front/js/custom.js"></script>
    <!-- Register -->
    <script src="<?= DOMAIN_NAME;?>front/js/register/register.js"></script>
    <!-- messages -->
    <script src="<?= DOMAIN_NAME;?>front/js/messages/message.js"></script>
